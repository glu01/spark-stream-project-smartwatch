...
class HistoryLoader():
    ...
    def load_date_lookup(self):        
        ...
        spark.sql(f"""INSERT OVERWRITE TABLE hive_metastore.{self.db_name}.date_lookup 
    ...
    def assert_count(self, table_name, expected_count):
        ...
        actual_count = spark.read.table(f"hive_metastore.{self.db_name}.{table_name}").count()
